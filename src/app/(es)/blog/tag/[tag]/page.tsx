...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const hasEnglishVersion = getPostsByTag(decodedTag, 'en').length > 0;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        ...(hasEnglishVersion && { 'en': `https://legasint.com/blog/en/tag/${tag}` }),
        'x-default': `https://legasint.com/blog/tag/${tag}`,
      },
    },
  };
}

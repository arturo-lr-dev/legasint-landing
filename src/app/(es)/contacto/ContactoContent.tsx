...
export default function ContactoContent() {
  ...
  const whatsappUrl = 'https://wa.me/34649355701?text=Hola%20Arturo%2C%20vi%20vuestra%20web%20y%20me%20gustar%C3%ADa%20hablar%20sobre%20un%20proyecto.%20%C2%BFCu%C3%A1ndo%20tienes%20un%20hueco%3F';
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-blue-200 mb-6">Respuesta rápida</p>
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  trackOutboundContact(whatsappUrl, GA_EVENTS.WHATSAPP_CLICK, 'contact_page_whatsapp');
                }}
              >
                <div
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-blue-200 mb-6">Para consultas detalladas</p>
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  trackOutboundContact(emailUrl, GA_EVENTS.EMAIL_CLICK, 'contact_page_email');
                }}
              >
                <div
                  className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"

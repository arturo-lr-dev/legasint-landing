...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const hasSpanishVersion = getPostsByTag(decodedTag, 'es').length > 0;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        ...(hasSpanishVersion && { 'es': `https://legasint.com/blog/tag/${tag}` }),
        'x-default': hasSpanishVersion
          ? `https://legasint.com/blog/tag/${tag}`
          : `https://legasint.com/blog/en/tag/${tag}`,
      },
    },
  };
}

...
date: "2026-02-10"
language: "en"
canonical: "https://legasint.com/blog/en/how-to-audit-code-from-previous-vendor"
tags: ["Code Audit", "Software Quality", "Technical Debt"]
---

# How to Audit Code from Your Previous Vendor

Practical guide to evaluate inherited code quality and make informed decisions about refactoring or migration.
...
### 🚩 2. Code without clear structure
...
### ✅ Refactor (improve existing code) if:
...
❌ **"My new vendor says it's a disaster, so it must be"**
   → Get a second opinion. Some are looking to sell big projects.

❌ **"The code is ugly, we need to rebuild"**
   → "Ugly" doesn't mean "bad". Functional ugly code > pretty broken code.

❌ **"They used PHP/jQuery/X old technology, it's trash"**
   → "Old" technology ≠ bad. Does it work? Is it maintainable? That matters more.

❌ **"It has some bugs, we need to throw it all away"**
   → All projects have bugs. Evaluate severity, not quantity.

❌ **"I don't understand the code, it must be wrong"**
   → Lack of documentation ≠ bad code. It may just be difficult to approach initially.
